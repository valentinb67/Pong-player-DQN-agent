...
def entrainer_dqn():
    ...
    Return:
        float: La valeur de la perte calculée lors de l'entraînement.
        list: Valeurs vérité (True Value) des échantillons.
        list: Valeurs estimées (Estimate Value) des échantillons.
        list: Erreurs TD (TD Error) pour chaque échantillon.
    """
