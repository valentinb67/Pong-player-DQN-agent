...
# Fichier CSV
csv_file = open('LearningData/1.1_q_learning_decay_log.csv', mode='w', newline='')
...
video_writer = cv2.VideoWriter('Records/1.1_q_table_record.avi', fourcc, fps, (largeur, hauteur))
