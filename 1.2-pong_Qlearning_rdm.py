...
q_table = defaultdict(lambda: np.random.uniform(-0.01, 0.01, len(actions)))
...
epsilon_decay = 0.995  # Facteur de décroissance de epsilon
epsilon_min = 0.9  # Valeur minimale pour epsilon

# CSV File for logging
csv_file = open('LearningData/1.2_q_learning_rdm_log.csv', mode='w', newline='')
...
video_writer = cv2.VideoWriter('Records/1.2_q_record_rdm.avi', fourcc, fps, (largeur, hauteur))
